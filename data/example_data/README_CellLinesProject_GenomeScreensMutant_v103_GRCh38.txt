...
-------------------------------------------------
 A tab separated table of coding point mutations from genome wide screens (including whole exome sequencing) from the current release. [ CellLinesProject_GenomeScreensMutant_v103_GRCh38.tsv.gz ]
