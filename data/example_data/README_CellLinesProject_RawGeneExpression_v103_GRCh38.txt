--------------------------------------
Cell Lines Project Raw Gene Expression
--------------------------------------
  The platform used was the Affymetrix Human Genome U219 Array. This file contains all the raw gene expression data from the most current release of COSMIC Cell Lines Project in a tab separated file. [ CellLinesProject_RawGeneExpression_v103_GRCh38.tsv.gz ]
...
[5:E]                 GENE_EXPRESSION                    Expression level for the gene from the Affymetrix Human Genome U219 Array data.
