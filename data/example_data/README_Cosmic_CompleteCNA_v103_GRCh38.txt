...
---------------------------
 All copy number variants from the current release in a tab separated table. For more information on copy number data, please see https://cancer.sanger.ac.uk/cosmic/help/cnv/overview. [ Cosmic_CompleteCNA_v103_GRCh38.tsv.gz ]
