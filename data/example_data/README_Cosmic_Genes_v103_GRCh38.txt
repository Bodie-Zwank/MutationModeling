...
COSMIC Genes
------------
 All the COSMIC gene data from the current release in a tab separated file. Genes are associated with COSMIC unique gene identifier, gene symbol, Ensembl gene identifier, Entrez and HGNC mapping. [ Cosmic_Genes_v103_GRCh38.tsv.gz ]
